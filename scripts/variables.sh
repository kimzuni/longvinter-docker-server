...
export SERVER_LOG_PATH="Longvinter/Saved/Logs/Longvinter.log"
...
if [ -z "$CFG_COMMUNITY_WEBSITE" ]; then
	export COMMUNITY_URL="None"
elif [[ "$CFG_COMMUNITY_WEBSITE" == "http"* ]]; then
	export COMMUNITY_URL=$CFG_COMMUNITY_WEBSITE
	export CFG_COMMUNITY_WEBSITE=${CFG_COMMUNITY_WEBSITE#*://}
else
	export COMMUNITY_URL="http://$CFG_COMMUNITY_WEBSITE"
fi
