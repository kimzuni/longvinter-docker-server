...
| ENABLE_PLAYER_LOGGING                      | 플레이어가 서버에 접속하거나 나갈 때 알림을 활성화 여부                                                                | true                                                                                                | true/false                                                                                                  | 0.1.9     |
| PLAYER_LOGGING_POLL_PERIOD                 | 지정한 초마다 플레이어 접속 및 퇴장 여부 체크                                                                        | 5                                                                                                   | !0                                                                                                          | 0.1.9     |
| ARM_COMPATIBILITY_MODE                     | 서버 업데이트를 위해 steamcmd를 실행할 때 Box86에서 QEMU로 호환성 계층을 전환합니다. 이 설정은 ARM64 호스트에만 적용 가능합니다. | false                                                                                               | true/false                                                                                                  | 0.1.0     |
